			...
			<div class="col-md-12">
				<div class="hero-ct">
					...
					<ul class="breadcumb">
						...
						<li> <span class="ion-ios-arrow-right"></span> Genre Romance</li>
					</ul>
				</div>
			</div>
		</div>
		...
		<div class="row ipad-width2">
			<div class="col-md-8 col-sm-12 col-xs-12">
				<div class="topbar-filter">
					...
					<a href="{{route('genre3')}}" class="ion-ios-list-outline active"> <span> Genre Romance</span></a>
					<a href="{{route('genre4')}}" class="ion-ios-list-outline"> <span> Genre Biography</span></a>
				</div>

				@foreach ($gens3 as $gen3)
				<div class="movie-item-style-2">
					<div class="mv-item-infor">
						<h6><a href="{{route('moviesingle',$gen3->id)}}">{{$gen3->title}}</a></h6>
						<p class="rate"><i class="ion-android-star"></i><span>Ratings:</span> /10</p>
						<p class="describe">{{$gen3->body}}</p>
					</div>
				</div>
				@endforeach				
			</div>
