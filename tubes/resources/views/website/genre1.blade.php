			...
			<div class="col-md-12">
				<div class="hero-ct">
					...
					<ul class="breadcumb">
						...
						<li> <span class="ion-ios-arrow-right"></span> Genre Fantasy</li>
					</ul>
				</div>
			</div>
		</div>
		...
		<div class="row ipad-width2">
			<div class="col-md-8 col-sm-12 col-xs-12">
				<div class="topbar-filter">
					...
					<a href="{{route('genre1')}}" class="ion-ios-list-outline active"> <span> Genre Fantasy</span></a>
				...
				@foreach ($gens1 as $gen1)
				<div class="movie-item-style-2">
					<div class="mv-item-infor">
						<h6><a href="{{route('moviesingle',$gen1->id)}}">{{$gen1->title}}</a></h6>
						<p class="rate"><i class="ion-android-star"></i><span>Ratings:</span> /10</p>
						<p class="describe">{{$gen1->body}}</p>
					</div>
				</div>
				@endforeach				
			</div>
