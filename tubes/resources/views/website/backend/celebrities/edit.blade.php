			...
			<div class="col-md-12">
				<div class="hero-ct ">
					...
					<ul class="breadcumb">
						...
						<li> <span class="ion-ios-arrow-right"></span>Celebrity Edit</li>
					</ul>
				</div>
			</div>
		</div>
...
<div class="col-md-9 col-sm-12 col-xs-12">
    <div class="form-style-1 user-pro" action="#">
        <form method="POST" action="{{route('celebrityupdate', $celeb->id)}}"  class="user" enctype="multipart/form-data">
        @csrf  
        @method('PUT')
            <h4>Edit Celebrity</h4>
            <div class="row">
                <div class="col-md-6 form-it {{ $errors->has('name') ? 'has-error' : '' }}">
                    <label>Name</label>
                    <input name="name" id="name" type="text" value="{{$celeb->name}}" placeholder="">
                    @if($errors->has('name'))
                ...
                <div class="col-md-6 form-it {{ $errors->has('full_name') ? 'has-error' : '' }}">
                    ...
                    <input name="full_name" id="full_name" type="text" value="{{$celeb->full_name}}" placeholder="">
            ...
            <div class="row">
                <div class="col-md-6 form-it {{ $errors->has('country') ? 'has-error' : '' }}">
                    <label>Country</label>
                    <input name="country" id="country" type="text" value="{{$celeb->country}}" placeholder="">
                ...
                <div class="col-md-6 form-it {{ $errors->has('height') ? 'has-error' : '' }}">
                    ...
                    <input name="height" id="height" type="number" value="{{$celeb->height}}" placeholder="">
            ...
            <div class="row">
                <div class="col-md-6 form-it {{ $errors->has('category') ? 'has-error' : '' }}">
                    ...
                    <option value="{{$celeb->category}}" >{{$celeb->category}}</option>
            ...
            <div class="row">
                <div class="col-md-6 form-it {{ $errors->has('birth_date') ? 'has-error' : '' }}">
                    ...
                    <input name="birth_date" id="birth_date" type="date" value="{{$celeb->birth_date}}" placeholder="">
                ...
                <div class="col-md-6 form-it">
                    ...
                    <input name="death_date" id="death_date" type="date" value="{{$celeb->death_date}}" placeholder="">
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-12 form-it  {{ $errors->has('link_facebook') ? 'has-error' : '' }}">
                    ...
                    <input name="link_facebook" id="link_facebook" type="url" name="link_facebook" value="{{$celeb->link_facebook}}" id="">
            ...
            <div class="row">
                <div class="col-md-12 form-it  {{ $errors->has('link_twitter') ? 'has-error' : '' }}">
                    ...
                    <input name="link_twitter" id="link_twitter" type="url" name="link_twitter" value="{{$celeb->link_twitter}}" id="">
            ...
            <div class="row">
                <div class="col-md-12 form-it  {{ $errors->has('link_instagram') ? 'has-error' : '' }}">
                    ...
                    <input name="link_instagram" id="link_instagram" type="url" name="link_instagram" value="{{$celeb->link_intagram}}" id="">
            ...
            <div class="row">
                <div class="col-md-12 form-it  {{ $errors->has('excerpt') ? 'has-error' : '' }}">
                    <label>Excerpt</label>
                    <textarea name="excerpt" id="excerpt" class="form-control" rows="4" cols="50">{{$celeb->excerpt}} </textarea>
            ...
            <div class="row">
                <div class="col-md-12 form-it  {{ $errors->has('biography') ? 'has-error' : '' }}">
                    ...
                    <textarea class="form-control" name="biography" id="biography" rows="4" cols="50">{{$celeb->biography}} </textarea>
