			...
			<div class="col-md-12">
				<div class="hero-ct ">
					...
					<ul class="breadcumb">
						...
						<li> <span class="ion-ios-arrow-right"></span>Movie Edit</li>
					</ul>
				</div>
			</div>
		</div>
...
<div class="col-md-9 col-sm-12 col-xs-12">
    <div class="form-style-1 user-pro" action="#">
        <form method="POST" action="{{route('movieupdate', $movie->id)}}"  class="user" enctype="multipart/form-data">
        @csrf  
        @method('PUT')
            <h4>Edit Movie</h4>
            <div class="row">
                <div class="col-md-6 form-it {{ $errors->has('title') ? 'has-error' : '' }}">
                    <label>Title</label>
                    <input name="title" id="title" type="text" value="{{$movie->title}}" placeholder="">
                    @if($errors->has('title'))
                 ...
                 <div class="col-md-6 form-it {{ $errors->has('country') ? 'has-error' : '' }}">
                    <label>Country</label>
                    <input name="country" id="country" type="text" value="{{$movie->country}}" placeholder="">
            ...
            <div class="row">
                <div class="col-md-6 form-it {{ $errors->has('run_time') ? 'has-error' : '' }}">
                    ...
                    <input name="run_time" id="run_time" type="number" value="{{$movie->run_time}}" placeholder="">
            ...
            <div class="row">
                <div class="col-md-6 form-it {{ $errors->has('release_date') ? 'has-error' : '' }}">
                    ...
                    <input name="release_date" id="release_date" type="date" value="{{$movie->release_date}}" placeholder="">
                ...
                <div class="col-md-6 form-it {{ $errors->has('mmpa_ratings') ? 'has-error' : '' }}">
                    ...
                    <input name="mmpa_ratings" id="mmpa_ratings" type="text" value="{{$movie->mmpa_ratings}}" placeholder="">
            ...
            <div class="row">
                <div class="col-md-12 form-it  {{ $errors->has('image') ? 'has-error' : '' }}">
                    ...
                    <input name="image" id="image" type="file" name="image" value="{{$movie->images}}" id="">
                    @if($errors->has('image'))
            ...
            <div class="row">
                <div class="col-md-12 form-it  {{ $errors->has('trailer') ? 'has-error' : '' }}">
                    ...
                    <input name="trailer" id="trailer" type="url" value="{{$movie->trailer}}" name="trailer" id="">
            ...
            <div class="row">
                <div class="col-md-12 form-it  {{ $errors->has('excerpt') ? 'has-error' : '' }}">
                    <label>Excerpt</label>
                    <textarea name="excerpt" id="excerpt" class="form-control" rows="4" cols="50">{{$movie->excerpt}} </textarea>
            ...
            <div class="row">
                <div class="col-md-12 form-it  {{ $errors->has('body') ? 'has-error' : '' }}">
                    ...
                    <textarea class="form-control" name="body" id="body" rows="4" cols="50">{{$movie->body}}</textarea>
                    @if($errors->has('body'))
