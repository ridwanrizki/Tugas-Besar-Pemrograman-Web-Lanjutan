			...
			<div class="col-md-12">
				<div class="hero-ct ">
					...
					<ul class="breadcumb">
						...
						<li> <span class="ion-ios-arrow-right"></span>Blog Create</li>
					</ul>
				</div>
			</div>
		</div>
...
<div class="col-md-9 col-sm-12 col-xs-12">
    <div class="form-style-1 user-pro" action="#">
        <form method="POST" action="{{route('blogstore')}}"  class="user" enctype="multipart/form-data">
        @csrf
            <h4>Add New Blog</h4>
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-12 form-it  {{ $errors->has('excerpt') ? 'has-error' : '' }}">
                    <label>Excerpt</label>
                    <textarea name="excerpt" id="excerpt" class="form-control" rows="4" cols="30"></textarea>
            ...
            <div class="row">
                <div class="col-md-12 form-it  {{ $errors->has('body') ? 'has-error' : '' }}">
                    <label>Body</label>
                    <textarea name="body" id="body" class="form-control" rows="4" cols="30"></textarea>
                    @if($errors->has('body'))
